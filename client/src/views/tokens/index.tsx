    ...
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex flex-col">
        ...
        <h4 className="md:w-full text-2x1 md:text-4xl text-center text-slate-300 my-2">
          <p>Lock your SPL Tokens in escrow for a specified amount of time.</p>
          <p className='text-slate-500 text-2x1 leading-relaxed'>Don't sell your Tokens, lock them!</p>
        </h4>
        ...
        <Box sx={{ width: 600 }}>
          <Typography id="input-text" gutterBottom>
            ...
            <div>
              ...
              >
                <MenuItem onClick={handleClose}>Unable to fetch tokens</MenuItem>
              </Menu>
            </div>
          <Typography id="input-text" gutterBottom>
          </Typography>
